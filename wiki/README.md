...
### 实体与页面类型
本文件夹下的每一篇笔记都代表一个具体的**实体 (Entity)**，如：
...
### 百科页面标准模板 (Metadata)
所有被编译出的 Wiki 词条页面，其头部均会带有规范的元数据，用以追踪置信度、确认时间以及原始文献出处：

```yaml
---
type: Library        # 实体类型
confidence: 0.85     # 置信度 (0.0 到 1.0)，随多重信源确认而上升，随时间久远而衰减
last_confirmed: 2026-06-09  # 最近一次核实的时间
sources:
  - "[[sources/2026-06-09-obsidian-setup.md]]"  # 链接回原始 sources 文件的证据链
---
